 ...
 * @author 11011_000
 */
public class TheoreticalMostEfficientPath implements BestPathStrategy {
    ...
    public double getBestPath(ArrayList<Junction> junctions, ArrayList<Section> sections, Junction j0, Junction j1, Vehicle vehicle, Deque<Junction> bestPathJunctions, Deque<Section> bestPathSections) {
        ...
        roadNetwork.createRoadNetwork(junctions, sections, vehicle, "workMostEfficient");
        
        double work = GraphAlgorithms.shortestPath(roadNetwork.getRoadNetwork(), j0, j1, bestPathJunctions);
